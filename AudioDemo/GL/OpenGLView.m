...
- (BOOL)loadShaders
{
    ...
    vertShaderURL = [[NSBundle mainBundle] URLForResource:@"Shaderr" withExtension:@"vsh"];
    ...
    fragShaderURL = [[NSBundle mainBundle] URLForResource:@"Shaderr" withExtension:@"fsh"];
