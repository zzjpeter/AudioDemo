...
@property (strong, nonatomic) UIButton *stopButton;// 停止录音按钮

@property (strong, nonatomic) UIButton *playRecordButton;// 播放录音
@property (strong, nonatomic) UIButton *stoPlayRecordButton;// 停止播放录音

- (void)record:(id)sender;// 开始录音
- (void)stop:(id)sender;// 停止录音

- (void)playRecord:(id)sender;// 播放录音
- (void)stopPlayRecord:(id)sender;// 停止播放录音
